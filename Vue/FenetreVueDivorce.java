...
public class FenetreVueDivorce extends JFrame {
    ...
    // Fenêtre principale
    public FenetreVueDivorce(Mairie1 mairie) {
        this.mairie = mairie;
        this.setTitle("Saisie de divorce");
        ...
        textes.add(IDfemme);
        textes.add(new JLabel("Date divorce:"));
        textes.add(date);

        // Action des boutons, ils fonctionnent avec la classe EcouteurMariage1
        EcouteurDivorce ecouteurMariage1 = new EcouteurDivorce(IDhomme, IDfemme, jourBox, moisBox, anneeBox, mairie, this);
